...
(function(mod) {
    ...
    var Vim = function() {
        ...
        function detachVimMap(cm, next) {
            ...
            if (!next || next.attach != attachVimMap) leaveVimMode(cm, false);
        }
        ...
        defineOption('filetype', undefined, 'string', ['ft'], function(
            name,
            cm
        ) {
     ...
     */
        ...
        var motions = {
            ...
            moveByScroll: function(cm, head, motionArgs, vim) {
                ...
                motionArgs.repeat = repeat;
                var curEnd = motions.moveByDisplayLines(
                    cm,
                    head,
                    motionArgs,
                    vim
        ...
        var actions = {
            ...
            incrementNumberToken: function(cm, actionArgs) {
                ...
                if (token) {
                    ...
                    var number =
                        parseInt(token) + increment * actionArgs.repeat;
