        ...
        function(cmCfg, modeCfg) {
            ...
            function blockNormal(stream, state) {
                ...
                if (state.indentationDiff >= 4) {
                    ...
                    state.indentation =
                        stream.column() + stream.current().length;
                    state.list = true;
            ...
            function local(stream, state) {
                if (
                    state.fencedChars &&
                    stream.match(state.fencedChars, false)
                ) {
            ...
            function inlineNormal(stream, state) {
                ...
                if (ch === '\\') {
                    ...
                    if (modeCfg.highlightFormatting) {
                        ...
                        var formattingEscape =
                            tokenTypes.formatting + '-escape';
                        return type
                ...
                token: function(stream, state) {
                    ...
                    if (stream != state.thisLine) {
                        ...
                        var indentation = stream
                            .match(/^\s*/, true)[0]
                            .replace(/\t/g, '    ').length;
                        state.indentationDiff = Math.min(
