...
(function(mod) {
    ...
    CodeMirror.defineMode('mscgen', function(_, modeConfig) {
        var language =
            languages[(modeConfig && modeConfig.language) || 'mscgen'];
        return {
    ...
    function produceTokenFunction(pConfig) {
        return function(pStream, pState) {
            ...
            if (!pState.inComment) {
                ...
                if (
                    pStream.match(wordRegexp(pConfig.singlecomment), true, true)
                ) {
                    pStream.skipToEnd();
                    return 'comment';
                }
            ...
            if (
                pStream.match(wordRegexpBoundary(pConfig.arcsWords), true, true)
            )
                return 'keyword';
