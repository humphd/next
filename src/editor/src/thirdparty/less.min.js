                ...
                function(a, b, c) {
                    ...
                    b.exports = function(b, c) {
                        ...
                        function i(a) {
                            for (
                                var b,
                                    d = m.getElementsByTagName('style'),
                                    e = 0;
                                e < d.length;
                                e++
                            )
            ...
            26: [
                function(a, b, c) {
                    var d = a('../tree/dimension'),
                        ...
                        h = function(a, b) {
                            switch (
                                ((b = Array.prototype.slice.call(b)), b.length)
                            ) {
                                case 0:
                                    throw {
                                        type: 'Argument',
                    ...
                    var d = a('../less-error'),
                        ...
                        i = function j(a, b, c) {
                            ...
                            function m(a) {
                                ...
                                return {
                                    lineNumber:
                                        h.getLocation(a, o.getInput()).line + 1,
                                    fileName: b,
                                };
                            }
                            var n,
                            ...
                            return {
                                parse: function(g, h, i) {
                                    ...
                                    if (
                                        ...
                                        for (
                                            var r = a.pluginManager.getPreProcessors(),
                                                s = 0;
                                            s < r.length;
                                            s++
                                        )
                                    ...
                                    try {
                                        o.start(g, a.chunkInput, function(
                                            a,
                                            e
                                        ) {
                                            throw new d(
                    ...
                    (m.prototype = new d()),
                            ...
                            for (f = 0; f < r.length; f++)
                                if (
                                    ...
                                    for (var u = 0; u < i.rules.length; u++)
                                        (l = i.rules[u]),
                                            l.copyVisibilityInfo(
                                                i.visibilityInfo()
                                            ),
                                            (l instanceof e && l.variable) ||
                                                r.splice(++f, 0, l);
                                }
                        ...
                        (m.prototype.matchCondition = function(a, b) {
                            ...
                            return (
                                ...
                                !(
                                    c.condition &&
                                    !c.condition.eval(new i.Eval(b, b.frames))
                                )
                            );
                        }),
